...
<template>
  ...
  <section class="my-12">
    <h1 class="w-full text-3xl text-end px-3 pr-12 text-blue-800">
      عن النادي الليبي لليخوت
    </h1>
    ...
    >
      ...
      <div>
        <h1 class="w-full text-3xl text-end px-3 pr-12 text-blue-500">
          الأصناف الرياضيه بنادي
        </h1>
        <p class="mt-4 text-white">
          نحن نضمن أعلى كفاءة في دوراتنا لتعلم اللغة الإنجليزية، من خلال تطبيق
          أساليب تجعلك تتعلم بسهولة وبشكل أسرع، نستخدم حلولًا تعليمية فريدة
          وأحدث التقنيات. كما انك ستحصل على إمكانية الوصول إلى الفصول الدراسية
          والمواد في أي وقت وأي مكان.
        </p>
        ...
        >
          ...
          >
            ...
            <p class="mt-2 text-sm text-gray-400">
              ...
              الرياضـي فيـه يبـدأ مـن ســن 19 ســنة و ليــس لــه حــد أقصــى
              فــي العمــر ، تنظــم لــه بطــوالت دوليــة مختلفــة و أبرزهــا
              بطولــة العالــم و األولمبيــاد الصيفيــة .
            </p>
          </div>
          <div
            class="border-t border-gray-200 pt-4"
          ...
          >
            <h2 class="font-semibold text-blue-600">
              صنف هوبي كات - Hobie Cat 16
            </h2>
            <p class="mt-2 text-sm text-gray-400">
              هـو قـارب متعـدد األبـدان و هـو قـارب زوجـي يعتبــر مــن أســرع
              األصنــاف و أصعبهــا ســن الرياضـي فيـه مـن 15 سـنة كحـد أدنـى و
              ليـس لــه حــد أقصــى فــي العمــر ، بطوالتــه الدوليــة معتمــدة
              فــي االتحــاد الدولــي و لكنــه ليــس صنــف أولمبــي
            </p>
          </div>
          <div
            class="border-t border-gray-200 pt-4"
          ...
          >
            <h2 class="font-semibold text-blue-600">
              صنف الألواح الشراعية - Windsurf
            </h2>
            <p class="mt-2 text-sm text-gray-400">
              األلــواح الشــراعية متعــددة االصنــاف ولجميــع هــذه األصنــاف
              بطــوالت معتمــدة دوليــا ، مــن أهــم األصنــاف بيــك تيكنــو 293
              وهــو صنــف بطــوالت الشــباب و أيضــا صنــف X-RS وهــو الصنـف
              المعتمـد أولمبيـا ، الفئـات السـنية فيـه متعــددة مــن 12 ســنة
              فمــا فــوق .
            </p>
          </div>
          <div
          ...
          >
            <h2 class="font-semibold text-blue-600">
              صنف الأوبتيموس - Optimist
            </h2>
            <p class="mt-2 text-sm text-gray-400">
              هو قـارب شـراعي فـردي يعـد الصنـف المعتمد دوليــا للناشــئين
              ويكــون عمــر الرياضــي فيــه مـن سـن 6 سـنوات و حتـى سـن 15 سـنة،
              حيـث تقـام بطـوالت دوليـة متعـددة لهـذا الصنـف و هـو ال يعتبـر
              صنـف أولمبـي .
            </p>
          </div>
          <div
          ...
          >
            ...
            <p class="mt-2 text-sm text-gray-400">
              ...
              تقـام لـه بطـوالت دوليـا أيضـا و هـو أيضـا ال يعتبــر صنــف
              أولمبــي .
            </p>
          </div>
          <div
    ...
    >
      <div>
        ...
        <p class="text-sm text-gray-500 mt-4 leading-relaxed text-end">
          هل لديك استفسار محدد أو تتطلع إلى استكشاف فرص جديدة؟ فريقنا ذو الخبرة
          مستعد للتعاون معك.
        </p>
